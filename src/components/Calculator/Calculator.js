...
const Calculator = () => {
    ...
    }, [propValue, ftbCheckBox, depPercent]);
    ...
    }, [stampDutyCost, legalCost, mortFee, survCost, addToMortgage]);
    ...
    }, [mortgagePayment, monthlyMaintenance, servCharge, groundRent]);
    
    useEffect(() => { // Buy Cost over Fixed Term
        const termCost = fixedTerm*monthlyCosts;
        var totalBuyCost = upFrontCosts+termCost;
        setTimePeriodCost(totalBuyCost);
    }, [upFrontCosts, monthlyCosts, fixedTerm]);
